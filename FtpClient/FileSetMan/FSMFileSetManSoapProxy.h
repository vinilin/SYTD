...
#ifndef FSMFileSetManSoapProxy_H
#define FSMFileSetManSoapProxy_H
#include "FSMH.h"

namespace FSM {

class SOAP_CMAC FileSetManSoapProxy : public soap
{ public:
	/// Endpoint URL of service 'FileSetManSoapProxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	FileSetManSoapProxy();
	/// Constructor with copy of another engine state
	FileSetManSoapProxy(const struct soap&);
	/// Constructor with engine input+output mode control
	FileSetManSoapProxy(soap_mode iomode);
	/// Constructor with engine input and output mode control
	FileSetManSoapProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~FileSetManSoapProxy();
	/// Initializer used by constructor
	virtual	void FileSetManSoapProxy_init(soap_mode imode, soap_mode omode);
