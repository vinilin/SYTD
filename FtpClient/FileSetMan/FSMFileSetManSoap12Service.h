...
#ifndef FSMFileSetManSoap12Service_H
#define FSMFileSetManSoap12Service_H
#include "FSMH.h"

namespace FSM {
class SOAP_CMAC FileSetManSoap12Service : public soap
{ public:
	/// Constructor
	FileSetManSoap12Service();
	/// Constructor with copy of another engine state
	FileSetManSoap12Service(const struct soap&);
	/// Constructor with engine input+output mode control
	FileSetManSoap12Service(soap_mode iomode);
	/// Constructor with engine input and output mode control
	FileSetManSoap12Service(soap_mode imode, soap_mode omode);
	/// Destructor frees all data
	virtual ~FileSetManSoap12Service();
	/// Initializer used by constructor
	virtual	void FileSetManSoap12Service_init(soap_mode imode, soap_mode omode);
	/// Create a copy
	virtual	FileSetManSoap12Service *copy();
