<%@ Control Language="C#" AutoEventWireup="true" CodeFile="commonGrid.ascx.cs" Inherits="commonGrid" %>

<table cellpadding="0" cellspacing="0" border="0">
   <tr style="display:none">
       <td>
         <table id="table2"  cellpadding="0" cellspacing="0" width="650" background="Images/Default/xpsj_g.gif">
              <tr>
      			<td align="left" style="width:40%" height="40">
                      <asp:label id="lbPageSummary_top" Runat="server"></asp:label></td>
                  <td align="right" style="width:60%">
                      <asp:linkbutton id="lbtnFristPage_top" runat="server" OnClick="lbtnFristPage_Click" CssClass="A1" style="font-family:webdings" Text="9" />
                          &nbsp;
                      <asp:linkbutton id="lbtnPrePage_top" runat="server" Visible="False" OnClick="lbtnPrePage_Click" CssClass="A1" style="font-family:webdings" Text="3" />&nbsp;
                      <asp:linkbutton id="lbtnPreDivision_top" runat="server" Visible="False" OnClick="lbtnPreDivision_Click" CssClass="A1">....</asp:linkbutton>&nbsp;
                      <asp:linkbutton id="lbtnPage1_top" runat="server" Visible="False" OnClick="lbtnPage1_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="1" />&nbsp;
                      <asp:linkbutton id="lbtnPage2_top" runat="server" Visible="False" OnClick="lbtnPage2_Click" CssClass="A1"  style="font-weight:bold;font-family:Arial;" Text="2" />&nbsp;
                      <asp:linkbutton id="lbtnPage3_top" runat="server" Visible="False" OnClick="lbtnPage3_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="3" />&nbsp;
                      <asp:linkbutton id="lbtnPage4_top" runat="server" Visible="False" OnClick="lbtnPage4_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="4" />&nbsp;
                      <asp:linkbutton id="lbtnPage5_top" runat="server" Visible="False" OnClick="lbtnPage5_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="5" />&nbsp;
                      <asp:linkbutton id="lbtnPage6_top" runat="server" Visible="False" OnClick="lbtnPage6_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="6" />&nbsp;
                      <asp:linkbutton id="lbtnPage7_top" runat="server" Visible="False" OnClick="lbtnPage7_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="7" />&nbsp;
                      <asp:linkbutton id="lbtnPage8_top" runat="server" Visible="False" OnClick="lbtnPage8_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="8" />&nbsp;
                      <asp:linkbutton id="lbtnPage9_top" runat="server" Visible="False" OnClick="lbtnPage9_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="9" />&nbsp;
                      <asp:linkbutton id="lbtnPage10_top" runat="server" Visible="False" OnClick="lbtnPage10_Click" CssClass="A1" style="font-weight:bold;font-family:Arial;" Text="10" />&nbsp;
                      <asp:linkbutton id="lbtnNextDivision_top" runat="server" Visible="False" OnClick="lbtnNextDivision_Click" CssClass="A1">....</asp:linkbutton>&nbsp;
                      <asp:linkbutton id="lbtnNextPage_top" runat="server" Visible="False" OnClick="lbtnNextPage_Click" CssClass="A1" style="font-family:webdings;" Text="4" />&nbsp;
                      <asp:linkbutton id="lbtnLastPage_top" runat="server"  Enabled="false" OnClick="lbtnLastPage_Click" CssClass="A1" style="font-family:webdings;" Text=":" /></td>
