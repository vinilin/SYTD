<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cartoonShow.aspx.cs" Inherits="cartoonShow" %>
                                   ...
                                   <tr>
                                       ...
                                       <td width="480" valign="top">
                                           <table  cellpadding="2" cellspacing="1" bgcolor="#95B5DC" width="100%">
                                               ...
                                               <tr>
                                                   <td height="25" align="left" bgcolor="#FFFFFF"><b>类别：</b><asp:Label ID="lbCartoonType" runat=server></asp:Label></td>
                                               </tr>
                                               <tr>
                                                   <td height="25" align="left" bgcolor="#FFFFFF"><b>集数：</b><asp:Label ID="lbCartoonNum" runat=server></asp:Label></td>
                                               </tr>
                                               <!--
                                               <tr>
...
<script language="javascript">
    ...
    {
        window.open ('cartoonplay.aspx?Id='+Id+'&num='+num, 'newwindow', 'height=390, width=500, top=150, left=250, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');        
    }
</script>