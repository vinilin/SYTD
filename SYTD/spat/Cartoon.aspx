<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cartoon.aspx.cs" Inherits="cartoon" %>
<%@ Register TagPrefix="uc"  TagName="header" Src="~/header.ascx"%>
<%@ Register TagPrefix="uc"  TagName="footer" Src="~/footer.ascx"%>
<%@ Register TagPrefix="uc" TagName="cartoonGrid" Src="~/cartoonGrid.ascx" %>
<html>
                                            ...
                                            <table  cellpadding="0" cellspacing="0" width="890" border="0">
                                                <tr>
                                                         ...
                                                         <tr>
                                                             <td>
                                                                <asp:Table ID="tablePlayTimes" runat="server" cellspacing="1" cellpadding="0" width="200" BorderWidth="0">
                                                                    <asp:tableRow>
                                                                         <asp:tableCell width="30" height="20" HorizontalAlign="center" backcolor="#2182CE" CssClass="STYLE1">序号</asp:tableCell>
                                                                         <asp:tableCell Width="170" HorizontalAlign="center" backcolor="#2182CE" CssClass="STYLE1">影片名称</asp:tableCell>
                                                                    </asp:tableRow>
                                                                </asp:Table>
                                                             </td>
                                                    ...
                                                    <td width="660" align="center" valign="top"  height="600">
                                                        <uc:cartoonGrid ID="ucGrid" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
