// ActionScript file
	...
	import SubModule.VidioNews.VidioNewsAudit.NewsAudit;
	import SubModule.VidioNews.VidioNewsAudit.NewsAuditSearch;
	...
	{
		var pop:NewsAudit=NewsAudit(PopUpManager.createPopUp(this,NewsAudit,true));
	...
	{
		var pop:NewsAuditSearch=NewsAuditSearch(PopUpManager.createPopUp(this,NewsAuditSearch,true));
