	...
	private var _ManagementCode:String = "015008";
	...
	public function set opKind(val:String):void
	{
		...
		if (val=="ADD")
		{
			this.title="增加栏目管理员和审核管理员管理（分站）";
		}
		else
		{
			this.title="修改栏目管理员和审核管理员管理（分站）";
	...
	private function initUserRole():void
	{
		...
		_remote.GetAllRoleByUserNameAndPPtrRole(this.__userName,"001",foreCloseRole);
