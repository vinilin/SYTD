	...
	private var _ManagementCode:String = "028001";
	...
	public function set opKind(val:String):void
	{
		...
		if (val=="ADD")
		{
			this.title="增加信息维护管理员和审核管理员";
		}
		else
		{
			this.title="修改信息维护管理员和审核管理员";
	...
	private function initUserRole():void
	{
		...
		_remote.GetAllRoleByUserNameAndPPtrRole(this.__userName,"041",foreCloseRole);
