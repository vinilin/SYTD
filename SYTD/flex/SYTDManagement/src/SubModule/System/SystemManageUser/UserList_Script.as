// ActionScript file
	...
	import SubModule.System.SystemManageUser.UserEdit;
	import SubModule.System.SystemManageUser.UserSearch;
	...
	private var _ManagementCode:String = "015002"; //该参数限定用户是哪个模块增加的
	...
	{
		if (parentApplication.checkFuncPopedom("015002002")){this.btnAdd.enabled=true;} else {this.btnAdd.enabled=false;}		
		if (parentApplication.checkFuncPopedom("015002003")){this.btnUpdate.enabled=true;} else {	this.btnUpdate.enabled=false;}
		if (parentApplication.checkFuncPopedom("015002004")){this.btnDelete.enabled=true;} else {this.btnDelete.enabled=false;}
	}
	*/
	private function Search():void
	{
		...
		_remote.GetUserList(this._search_condition_userName,
						   ...
						   this._search_condition_subCode,
