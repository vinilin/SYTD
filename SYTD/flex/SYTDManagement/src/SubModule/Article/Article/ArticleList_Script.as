// ActionScript file
	...
	import SubModule.Article.Article.ArticleEdit;
	import SubModule.Article.Article.ArticleSearch;
	...
	{	
		...
		switch(this._param.toUpperCase())
		{
			case "001":
				...
				this.lbTitle.text = "◎  石油要闻 —— 信息维护";
				break;
			    
			case "002":
				this.SRC_COLUMN.visible = true;
				this._isExistIcon = true;
			    this.lbTitle.text = "◎  图片新闻 —— 信息维护";
				break;
			
			case "003":
			    this._isExistKind = true;
			    this.lbTitle.text = "◎  企业文化 —— 信息维护";
			     break;
			
			case "004":
				this._isExistKind = true;
			    this.lbTitle.text = "◎  技术资讯 —— 信息维护";
				break;
			
			case "006":
				this._isExistKind = true;
			    this.lbTitle.text = "◎  为您服务 —— 信息维护";
				break;
			...
			case "008":
				...
				this._subName = parentApplication._userInfo.subName;
				this.SUB_COLUMN.visible = true;
			    this.lbTitle.text = "◎  矿区服务 —— 信息维护";
				break;  
				    
			case "009":
				this._isExistKind = true;
			    this.lbTitle.text = "◎  专题报道 —— 信息维护";
				break;  
