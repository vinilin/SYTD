// ActionScript file
	...
	import SubModule.Article_Kqfw.Article.ArticleAdd;
	import SubModule.Article_Kqfw.Article.ArticleEdit;
	import SubModule.Article_Kqfw.Article.ArticleSearch;
	...
	private var _kindCodes:ArrayCollection = new ArrayCollection;
	...
	private function initUserKindCode():void
	{
		_remote = new RemoteObject("fluorine");
		_remote.source = "ManagementService.Security.User";
		_remote.showBusyCursor = true;
		_remote.GetKqfwKindCode(parentApplication._userInfo.userName,
								"042");
		_remote.addEventListener(ResultEvent.RESULT,OnGetUserKindCodeResult);
		_remote.addEventListener(FaultEvent.FAULT,OnGetUserKindCodeFault);						
	}
	private function OnGetUserKindCodeResult(evt:ResultEvent):void
	{
		_remote.removeEventListener(ResultEvent.RESULT,OnGetUserKindCodeResult);
		_remote.removeEventListener(FaultEvent.FAULT,OnGetUserKindCodeFault);
		this._kindCodes = _remote.GetKqfwKindCode.lastResult as ArrayCollection;
		Search();
	}
	private function OnGetUserKindCodeFault(evt:FaultEvent):void
	{
		_remote.removeEventListener(ResultEvent.RESULT,OnGetUserKindCodeResult);
		_remote.removeEventListener(FaultEvent.FAULT,OnGetUserKindCodeFault);
	}
	public function Search():void
	{
		...
		_remote.showBusyCursor=true;
		_remote.GetKQFWArticleList(this._subCode,
							//this._kindCodes,
							this._param,
	...
	{
		_searchResult=_remote.GetKQFWArticleList.lastResult as ArrayCollection;
	...
	{
		//var pop:ArticleAdd = ArticleAdd(PopUpManager.createPopUp(this,ArticleAdd,true));
		var pop:ArticleEdit = ArticleEdit(PopUpManager.createPopUp(this,ArticleEdit,true));
	...
	{		
		...
		if (opKind=="ADD")
		{
			...
			obj.ARTICLEKIND2 = articleKind;
			obj.ARTICLEKINDNAME2 = articleKindName;
			obj.STATE = state;
		...
		else
		{
			...
			obj.ARTICLEKIND = articleKind;
			obj.ARTICLEKINDNAME = articleKindName;
			obj.ARTICLEKIND2 = articleKind2;
			obj.ARTICLEKINDNAME2 = articleKindName2;
			obj.STATE = state;
			obj.STATENAME = stateName;
			obj.ARTICLETITLE = articleTitle;
			obj.ADDMAN  = addMan;
	...
	{
		var pop:ArticleSearch=ArticleSearch(PopUpManager.createPopUp(this,ArticleSearch,true));
