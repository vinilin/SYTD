	...
	public function set kindCodes(val:ArrayCollection):void
	{
		this._kindCodes = val;
	}
	...
	{	
		//initUserKindCode();
		//initKind2(this._kindCodes.source[0].CODE);
	...
	{
		this.cbox_kind.dataProvider = this._kindCodes;
		this.cbox_kind.labelField = "TEXT";
	}
	private function initKind2(kindCode1:String):void
	{   
		_remote2 = new RemoteObject("fluorine");
		_remote2.source = "ManagementService.Sys.SystemKind";
		_remote2.showBusyCursor = true;
		_remote2.GetAllKind(this._subCode,this._param,kindCode1);
	...
	private function OnSaveResult(evt:ResultEvent):void
	{
		...
		var result:String = _remote.AddArticle.lastResult as String;
		if (result!=null)
		{
