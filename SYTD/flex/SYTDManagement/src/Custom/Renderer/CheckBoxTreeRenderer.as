package Custom.Renderer
{
	...
	public class CheckBoxTreeRenderer extends TreeItemRenderer
	{
        ...
        private var imageWidth:Number     = 14;
        private var imageHeight:Number     = 14;
        private var inner:String     = "images/inner.png";
        ...
        override protected function createChildren():void {
            ...
            myImage.addEventListener( MouseEvent.CLICK, checkBoxToggleHandler );
       ...
       override protected function updateDisplayList(unscaledWidth:Number,unscaledHeight:Number):void
       {
            ...
            if(super.data)
            {
                ...
                if (data.@state == STATE_SCHRODINGER) {
                    myImage.x = myCheckBox.x + 0;
                    myImage.y = myCheckBox.y - 7;
