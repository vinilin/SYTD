...
namespace ManagementService.FileT
{
    ...
    public class Movie
    {
        ...
        [DataTableType("Movie.GetMovieList")]
        public DataTable GetList(string movieName,
            string publishType,
            string addMan,
            string addStartTime,
            string addEndTime,
        ...
        {
            movieName = Com.Com.checkSql(movieName);
            ...
            fieldCollections += "Movie.PLAYER,";
            fieldCollections += "Movie.DIRECTOR,";
            ...
            string joinConditions = " left join PublishType on PublishType.ID = BaseItem.publishType and PublishType.category = 1 ";
        ...
        [DataTableType("Movie.GetMovieInfoById")]
        public DataTable GetMovieInfoById(string BaseItemId)
        {
        ...
        public string AddMovie(string owner,
            string subCode,
            string title,
            int publishType,
            ...
            string srcIp)
        {
            ...
            player = Com.Com.checkSql(player);
            director = Com.Com.checkSql(director);
            ...
            else
            {
                ...
                FT.Movie mv = new ManagementService.FT.Movie();
                mv.Player = player;
        ...
        //发布未通过可以让发布站点人员删除
        //未发布的应可以让审核人员删除
        [DataTableType("Movie.DeleteMovie")]
        public DataTable DeleteMovie(FluorineFx.AMF3.ArrayCollection movies)
        {
            ...
            {
                System.Collections.Hashtable uMovies = (System.Collections.Hashtable)movies[i];
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                FT.MasterControl control = new ManagementService.FT.MasterControl();
                control.Url = new Common.SysConfig().GetManterControl();
                control.RemoveMovie(Convert.ToInt64(dt.Rows[i]["ID"]));

                dt.Rows[i]["result"] = result;
            }
            return dt;
        }
        public string GetMoviePlayUrl(long id)
        {
            try
            {
                string url = new Common.SysConfig().GetVodPlayUrl();
            }
            catch (Exception e)
            {
            }
        ...
        public string AuditMovie(int id,int auditResult,string auditReason,string auditMan)
        {
        ...
        public string PublishMovie(long id, string[] dst)
        {
        ...
        [DataTableType("Moive.GetFileSet")]
