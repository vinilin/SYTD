...
[System.Web.Services.WebServiceBindingAttribute(Name="Trans", Namespace="http://localhost:50000/")]
public partial class Trans : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:ftp", ResponseNamespace="urn:ftp", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    [return: System.Xml.Serialization.XmlElementAttribute("response")]
    public int Transform(ArrayOfFile flist, Position position) {
    ...
    [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:ftp", ResponseNamespace="urn:ftp", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    [return: System.Xml.Serialization.XmlElementAttribute("response")]
    public int Delete([System.Xml.Serialization.XmlElementAttribute(DataType="positiveInteger")] string id) {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginDelete(string id, System.AsyncCallback callback, object asyncState) {
    ...
    public System.IAsyncResult BeginDeleteAll(System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("DeleteAll", new object[0], callback, asyncState);
    }
    
    /// <remarks/>
    public int EndDeleteAll(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((int)(results[0]));
    }
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:ftp", ResponseNamespace="urn:ftp", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    [return: System.Xml.Serialization.XmlElementAttribute("total", DataType="positiveInteger")]
    public string GetState([System.Xml.Serialization.XmlElementAttribute(DataType="positiveInteger")] out string downloaded, [System.Xml.Serialization.XmlElementAttribute(DataType="positiveInteger")] out string fsize, [System.Xml.Serialization.XmlElementAttribute(DataType="positiveInteger")] out string fdownloaded, out Status status, out string fname) {
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
[System.Xml.Serialization.XmlTypeAttribute(Namespace="urn:ftp")]
